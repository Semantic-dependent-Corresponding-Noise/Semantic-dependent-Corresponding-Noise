...
# 1. 读取txt数据
file_path = '/home/zbm/xjd/NPC-master/dataset/k_means_MSCOCO/annotations/scan_split/0_noise_train_caps.txt'  # 替换为你的文件路径
...
# 5. K-means聚类
n_clusters = 9700  # 你可以根据需要调整聚类的数量
...
# 8. 输出结果
output_file = f'/home/zbm/xjd/NPC-master/dataset/k_means_MSCOCO/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'  # 替换为你的输出文件路径
