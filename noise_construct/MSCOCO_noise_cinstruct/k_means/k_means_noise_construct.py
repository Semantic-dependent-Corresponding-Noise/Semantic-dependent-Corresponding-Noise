...
# Output file path
output_file = f'/home/zbm/xjd/NPC-master/dataset/k_means_MSCOCO/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'  
...
print(f"Replaced data saved to {output_file}")
print(f"Total images processed: {len(image_descriptions)}")
print(f"Total text replacements made: {len(replacements)}")
