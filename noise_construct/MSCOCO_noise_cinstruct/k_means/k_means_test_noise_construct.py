...
# 1. 读取txt数据
file_path = '/home/zbm/xjd/NPC-master/dataset/k_means_MSCOCO/annotations/scan_split/test_caps.txt'  # 替换为你的文件路径
...
# 8. 输出结果
output_file = '/home/zbm/xjd/NPC-master/dataset/k_means_MSCOCO/annotations/scan_split/test_caps_kmeans.txt'  # 替换为你的输出文件路径
