...
# 噪声文件路径
noise_file_path = '/home/zbm/xjd/NPC-master/dataset/incomplete_description_noise_MSCOCO/annotations/scan_split/1.0_noise_train_caps.txt'
...
for replace_ratio in replace_ratios:
    ...
    # 输出文件路径
    output_file_path = f'/home/zbm/xjd/NPC-master/dataset/incomplete_description_noise_MSCOCO/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'
