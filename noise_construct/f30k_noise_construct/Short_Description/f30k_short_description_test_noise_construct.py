...
# Read text file
file_path = '/path/dataset/Short_Description_noise_f30k/annotations/scan_split/test_caps.txt'
...
output_test_file_path = '/path/dataset/Short_Description_noise_f30k/annotations/test_caps.txt'
