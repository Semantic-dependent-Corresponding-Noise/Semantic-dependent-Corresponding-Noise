...
# 噪声文件路径
noise_file_path = '/data/xjd/study/NPC/dataset/incomplete_description/annotations/scan_split/1.0_noise_train_caps2.txt'
...
# 输出文件路径
output_file_path = f'/data/xjd/study/NPC/dataset/incomplete_description/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'
