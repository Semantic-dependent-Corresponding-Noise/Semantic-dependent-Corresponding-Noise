...
# 1. 读取txt数据
file_path = '/home/zbm/xjd/NPC-master/dataset/k_means_f30k/annotations/scan_split/0_noise_train_caps.txt'  # 替换为你的文件路径
...
# 8. 输出结果
output_file = f'/home/zbm/xjd/NPC-master/dataset/k_means_f30k/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'  # 替换为你的输出文件路径
