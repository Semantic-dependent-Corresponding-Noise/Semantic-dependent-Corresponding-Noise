...
if __name__ == "__main__":
    ...
    input_directory = "/path/noise_construct/MSCOCO_noise_construct/Short_Description/original"
    output_directory = "/path/noise_construct/MSCOCO_noise_construct/Short_Description/noise"
    replace_ratio = 1.0
