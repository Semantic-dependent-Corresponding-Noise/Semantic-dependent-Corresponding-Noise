...
if __name__ == "__main__":
    ...
    input_directory = "/path/noise_construct/MSCOCO_noise_construct/Short_Description/noise"
    output_file_path = "/path/noise_construct/MSCOCO_noise_construct/Short_Description/1.0_noise_train_caps_preliminary.txt"
