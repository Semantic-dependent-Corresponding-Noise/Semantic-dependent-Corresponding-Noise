...
# Input file path
file_path = '/path/dataset/High_level_Semantic_Confusion_MSCOCO/annotations/scan_split/test_caps.txt'
...
# Output file path
output_file = '/path/dataset/High_level_Semantic_Confusion_MSCOCO/annotations/scan_split/test_caps_kmeans.txt'
