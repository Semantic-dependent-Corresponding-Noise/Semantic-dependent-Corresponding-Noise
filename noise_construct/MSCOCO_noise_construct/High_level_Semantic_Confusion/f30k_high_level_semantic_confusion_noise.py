...
# Noise file path
noise_file_path = '/path/dataset/High_level_Semantic_Confusion_MSCOCO/annotations/scan_split/1.0_noise_train_caps.txt'
...
for replace_ratio in replace_ratios:
    ...
    # Output file path
    output_file_path = f'/path/dataset/High_level_Semantic_Confusion_MSCOCO/annotations/scan_split/{replace_ratio}_noise_train_caps.txt'
    ...
    print(f"Texts with {replace_ratio} replacement ratio saved to {output_file_path}")
    print(f"Number of texts replaced: {num_to_replace}/{num_texts}")
